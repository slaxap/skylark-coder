var pathUtil = require("scripts/brackets/path"),
...
/**
 * Provides a special require-proxy. Every module calls require("scripts/brackets/rewire").getProxy(require, __filename) at the
