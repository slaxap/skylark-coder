 ...
 * of the module. Additionally it forwards all calls of require("scripts/brackets/rewire") to the module
...
function browserifyMiddleware(b) {
    ...
    function doInjectRewire(src, filename) {
        ...
        if (filename.indexOf(rewireLib) === -1) {
            ...
            src += ' module = require("scripts/brackets/rewire").getIndependentModule(module);';
        }
