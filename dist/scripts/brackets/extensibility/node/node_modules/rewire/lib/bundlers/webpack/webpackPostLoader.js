 ...
 *
 * Furthermore it changes all calls of rewire("some/path") to rewire("some/path", require("scripts/brackets/some/path")) so webpack
...
function webpackPostLoader(src) {
    ...
    if (isRewireableModule(filename)) {
        // replaces rewire("some/path") into rewire("some/path", require("scripts/brackets/some/path"))
